...
// Renders a real frame from the video as a thumbnail, using the presigned
// inline URL. Falls back to a generic icon if there's no URL or it fails to load.
...
function VideoCard({
  ...
  return (
    ...
    >
      {/* Thumbnail area */}
      <div className="relative w-full aspect-video bg-gradient-to-br from-slate-700 to-slate-900 flex items-center justify-center overflow-hidden">
        <VideoThumb url={video.view_url} />
        {/* Play overlay */}
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-1">My Videos</h1>
